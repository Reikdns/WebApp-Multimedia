    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "Su contraseña se ha cambiado.", If(message = "SetPwdSuccess", "Su contraseña se ha establecido.", If(message = "RemoveLoginSuccess", "La cuenta se quitó.", [String].Empty)))
